...
private extension TVTimeCSVExportParserTests {
    ...
    func makeExportFolderWithSplitSeenEpisodes() throws -> URL {
        let rootURL = FileManager.default.temporaryDirectory
            .appending(path: UUID().uuidString, directoryHint: .isDirectory)
    ...
    func seenEpisodeCSV(episode: Int, updatedAt: String) -> String {
