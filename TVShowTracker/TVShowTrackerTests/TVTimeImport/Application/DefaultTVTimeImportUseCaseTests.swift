//
//  DefaultTVTimeImportUseCaseTests.swift
//  TVShowTrackerTests
//
...
@MainActor
struct DefaultTVTimeImportUseCaseTests {
...
private extension DefaultTVTimeImportUseCaseTests {
    func makeCandidate() -> MediaCandidate {
        MediaCandidate(
            provider: .tmdb,
            providerID: 42,
            kind: .tvShow,
    ...
    func makeUseCase(
        ...
        return DefaultTVTimeImportUseCase(
            tvTimeExportParser: TVTimeExportParserStub(export: export),
