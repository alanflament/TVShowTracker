...
private struct AniListDetailsGraphQLRequest: Encodable {
    let query: String
    let variables: [String: Int]
}

private struct AniListDetailsResponse: Decodable {
...
private struct AniListDetailsAnime: Decodable {
    let id: Int
...
private struct AniListAiringSchedule: Decodable {
