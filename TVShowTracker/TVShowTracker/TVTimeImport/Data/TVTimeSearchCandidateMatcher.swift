...
struct TVTimeSearchCandidateMatcher {
    func match(_ show: TVTimeShow, in catalog: SearchCatalog) -> SearchCandidate? {
    ...
    private func exactMatches(in candidates: [SearchCandidate], for show: TVTimeShow) -> [SearchCandidate] {
